...
from backend import transnetv2, detect_shot
from backend.detect import detectScene
...
class VideoPlayer(QMainWindow):
    def __init__(self, mp4_filepath, scenes):
        ...
        play_button.clicked.connect(self.play_button_func)
        pause_button = QPushButton('Pause')
        pause_button.clicked.connect(self.pause_button_func)
        stop_button = QPushButton('Stop')
        stop_button.clicked.connect(self.stop_button_func)
